...
| :--- | :--- |
| `--fasta_path` | **(Required)** Absolute path to the input `.fasta` file containing your protein sequence(s). |
| `--mtz_path` | **(Required)** Absolute path to the unphased reflection data `.mtz` file. |
